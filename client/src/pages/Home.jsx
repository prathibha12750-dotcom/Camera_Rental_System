...
const categories = [
  {
    title: "Cameras",
    text: "Discover DSLR, mirrorless and video camera options available through the system.",
    image: cameraImage,
  },

  {
    title: "Lenses",
    text: "Explore lens options suitable for portraits, events, productions and creative work.",
    image: lensImage,
  },

  {
    title: "Studio Gear",
    text: "Discover lighting and supporting equipment for studio and location photography.",
    image: studioImage,
  },

  {
    title: "Photographers",
    text: "Discover professional photographers and learn about the photography services available.",
    image: photographerImage,
    link: "/photographers",
  },
];
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            ...
            <p className="max-w-lg text-sm leading-7 text-gray-600 sm:text-base">
              ...
              Browse the types of camera equipment available
              through the platform and discover photographers
              who can help bring your ideas to life.
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-gray-950 sm:text-4xl lg:text-5xl">
              Discover professional gear for your next shoot.
            </h2>


            <p className="mt-6 max-w-xl text-base leading-8 text-gray-600">

              Explore cameras, lenses, studio equipment and
              supporting photography gear available through
              Southern Camera Rental.

              When you find what you need, sign in to your
              customer account to check the rental workflow
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-[0.85fr_1.15fr] lg:gap-16 lg:px-8">
          ...
          <div>
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl lg:text-5xl">
              Discover the right photographer for your moment.
            </h2>


            <p className="mt-6 max-w-xl leading-8 text-gray-300">

              Explore the photography services available through
              the platform and discover professional photographers
              for events, portraits, celebrations and creative projects.

              When you are ready to make a booking request,
              register or login to your customer account.
            ...
            <div className="grid gap-4 pt-10">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
                ...
                <p className="mt-2 text-xl font-bold">
                  Find a photographer that matches your needs.
                </p>

                <p className="mt-3 text-sm leading-6 text-gray-400">

                  Explore photography services first,
                  then login to your account when you
                  are ready to continue with a booking.
      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-black tracking-tight text-gray-950 sm:text-4xl">
              Discover first. Login when you are ready.
            </h2>


            <p className="mt-4 leading-7 text-gray-600">

              Visitors can explore the services from the
              public website.

              A customer account is required before
              equipment rental or photographer booking
        ...
        <section className="bg-[#f7f7f5] px-6 py-20 sm:py-24">
          ...
          <div className="relative mx-auto max-w-7xl overflow-hidden rounded-3xl bg-orange-600 px-7 py-14 text-white sm:px-12 lg:px-16">
            ...
            <div className="relative max-w-2xl">
              ...
              <h2 className="mt-3 text-3xl font-black tracking-tight sm:text-4xl lg:text-5xl">
                Register or login to start renting and booking.
              </h2>
              ...
              <p className="mt-5 max-w-xl leading-7 text-orange-50">
                ...
                A customer account is required when you
                want to rent equipment, request a photographer,
                manage requests or view your booking activity.
      ...
      <footer className="bg-gray-950 text-gray-300">
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 py-12 md:grid-cols-[1.4fr_0.8fr_0.8fr] lg:px-8">
          ...
          <div className="max-w-md">
            ...
            <p className="mt-5 text-sm leading-7 text-gray-400">
              ...
              Discover camera equipment and professional
              photographers through one platform.

              Register or login when you are ready to rent
              equipment or submit a photographer booking request.
        ...
        <div className="border-t border-white/10">
          ...
          <div className="mx-auto flex max-w-7xl flex-col gap-2 px-6 py-5 text-xs text-gray-500 sm:flex-row sm:items-center sm:justify-between lg:px-8">
            ...
            <p>
              © 2026 Southern Camera Rental. All rights reserved.
            </p>

            <p>
              Camera Equipment Rental & Photographer Booking System
            </p>
