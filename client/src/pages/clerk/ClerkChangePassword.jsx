...
const ClerkChangePassword = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSuccess(
        "Password changed successfully. Redirecting to your clerk dashboard..."
      );
        ...
        <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-xl">
          ...
          <div className="bg-gray-950 px-7 py-8 text-white sm:px-10">
            ...
            <p className="mt-4 text-sm leading-7 text-gray-300">
                Your clerk account was created using a
                temporary password. You must replace it
                before accessing clerk features.
            </p>
...
export default ClerkChangePassword;